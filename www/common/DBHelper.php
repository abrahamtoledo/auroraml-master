    ...
    */
    ...
    public static function Query($query, &$error = ""){
        ...
        elseif($qres){
            ...
            $error = sprintf("Error %d : %s", mysql_errno(self::$mysqlObject->_db_linkid), mysql_error(self::$mysqlObject->_db_linkid));
            return false;
        }
    }
    ...
    */
    ...
    public static function mysql_scape_array($array){
         ...
         foreach ($array as $key => $val){
             $results[mysql_real_escape_string($key)] = mysql_real_escape_string($val);
         }
         return $results;
    }
