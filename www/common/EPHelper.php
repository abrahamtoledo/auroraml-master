...
";
    ...
    */
	...
	public static function PostUrl($url, $pdata, $timeout = 5, &$transfer_info = NULL, $cookie_file = "", $referer="", $urlencoded=false, &$responseHttpHeaders=null){
 		
		//Logs::GetInstance()->addEntry("Referer: $referer");
